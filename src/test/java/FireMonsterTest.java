...
public class FireMonsterTest {
  ...
  public void fireMonster_instantiatesCorrectly_true() {
    FireMonster testFireMonster = new FireMonster("Flamey", 1);
  ...
  public void FireMonster_instantiatesWithName_String() {
    FireMonster testFireMonster = new FireMonster("Flamey", 1);
    assertEquals("Flamey", testFireMonster.getName());
  }
  ...
  public void equals_returnsTrueIfNameAndPersonIdAreSame_true() {
    FireMonster testFireMonster = new FireMonster("Flamey", 1);
    FireMonster anotherFireMonster = new FireMonster("Flamey", 1);
  ...
  public void all_returnsAllInstancesOfFireMonster_true() {
    FireMonster firstFireMonster = new FireMonster("Flamey", 1);
  ...
  public void save_savesPersonIdIntoDB_true() {
    ...
    testPerson.save();
    FireMonster testFireMonster = new FireMonster("Flamey", testPerson.getId());
    testFireMonster.save();
